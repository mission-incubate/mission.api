...
import {Request, CacheManager, RedisCacheProvider} from '../../../Core';
...
export class UserService extends BaseService {
    ...
    public async FindById(req: ApiRequest<ISearchEnums>): Promise<ApiResponse<UserInstance>> {
        if (req.Id < 0) {
            throw 'Invaid Id';
        }
    ...
    public async GetAllUsers(req: ApiRequest<ISearchEnums>): Promise<ApiResponse<Array<UserInstance>>> {
